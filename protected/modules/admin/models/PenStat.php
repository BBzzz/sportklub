...
/**
 * This is the model class for table "tbl_pen_stat".
 *
 * The followings are the available columns in table 'tbl_pen_stat':
 ...
 */
class PenStat extends CActiveRecord
{
	/**
	...
	public function rules()
	{
		...
		return array(
			array('g_id, e_time, action, pl_name', 'required'),
			array('g_id, pl_id, t_id', 'length', 'max'=>11),
			array('action, pl_name', 'length', 'max'=>50),
			// The following rule is used by search().
			// @todo Please remove those attributes that should not be searched.
			array('g_id, e_time, pl_id, t_id, action, pl_name', 'safe', 'on'=>'search'),
		);
	}
	 ...
	 * @return PenStat the static model class
	 */
